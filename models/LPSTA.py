...
class LPSTA(nn.Module):

    def __init__(self, num_classes, model_name, pretrain_choice, seq_len, layer_num=3, feature_method='cat',
        ...
        t = seq_len
        self.layer1 = STAM(inplanes=self.plances, mid_planes=self.mid_channel, num= '1')
        self.layer2 = STAM(inplanes=self.plances, mid_planes=self.mid_channel, num= '2')
        self.layer3 = STAM(inplanes=self.plances, mid_planes=self.mid_channel, num= '3')
